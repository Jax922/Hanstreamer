...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/fingerpose.js":[function(require,module,exports) {
var define;
!function (t, e) {
  ...
  return function (t) {
      ...
      return e = t, (n = [{
        ...
        value: function (t, e, n, r) {
          var i = t[0] - e[0],
              ...
              y = 0,
              g = d / (s + 1e-5);
          g > 1.5 ? h += this.options.DISTANCE_VOTE_POWER : g > .66 ? p += this.options.DISTANCE_VOTE_POWER : y += this.options.DISTANCE_VOTE_POWER;
    ...
    var R = function () {
      function t(e) {
        !function (t, e) {
          if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
        }(this, t), this.name = e, this.curls = {}, this.directions = {};
      }
    ...
    I.addDirection(a.Thumb, l.VerticalUp, 1), I.addDirection(a.Thumb, l.DiagonalUpLeft, 1), I.addDirection(a.Thumb, l.DiagonalUpRight, 1), I.addCurl(a.Index, o.NoCurl, 1), I.addDirection(a.Index, l.VerticalUp, 1), I.addDirection(a.Index, l.DiagonalUpLeft, 1), I.addDirection(a.Index, l.DiagonalUpRight, 1), I.addDirection(a.Index, l.HorizontalLeft, 1), I.addDirection(a.Index, l.HorizontalRight, 1), I.addCurl(a.Middle, o.NoCurl, 1), I.addDirection(a.Middle, l.VerticalUp, 1), I.addDirection(a.Middle, l.DiagonalUpLeft, 1), I.addDirection(a.Middle, l.DiagonalUpRight, 1), I.addDirection(a.Middle, l.HorizontalLeft, 1), I.addDirection(a.Middle, l.HorizontalRight, 1), I.addCurl(a.Ring, o.FullCurl, 1), I.addCurl(a.Ring, o.HalfCurl, .9), I.addCurl(a.Pinky, o.FullCurl, 1), I.addCurl(a.Pinky, o.HalfCurl, .9);

    var L = I,
        _ = new R("thumbs_up");

    _.addCurl(a.Thumb, o.NoCurl, 1), _.addDirection(a.Thumb, l.VerticalUp, 1), _.addDirection(a.Thumb, l.DiagonalUpLeft, .9), _.addDirection(a.Thumb, l.DiagonalUpRight, .9);

    for (var E = 0, j = [a.Index, a.Middle, a.Ring, a.Pinky]; E < j.length; E++) {
      var x = j[E];
      _.addCurl(x, o.FullCurl, 1), _.addCurl(x, o.HalfCurl, .9);
    }
...
},{}]},{},["src/fingerpose.js"], null)
//# sourceMappingURL=/fingerpose.e4afc503.js.map